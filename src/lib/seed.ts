    ...
    movies: [
      {
        ...
        status: "watched",
        rating: 10,
        review: "Quiet, gorgeous, and emotionally precise.",
        watched_date: dateOnly(-6),
        source: "mal",
        external_id: "52991",
        ...
        synopsis: "After the party of heroes defeated the Demon King, they all went their separate ways. Frieren, an elf mage, has a much longer lifespan than the others — and begins a new journey.",
        site_url: "https://myanimelist.net/anime/52991",
        community_score: 9.3,
        airing_status: "Finished Airing",
        catalog: { duration: "24 min per ep", season: "Fall 2023", studios: ["Madhouse"], source_material: "Manga" },
        created_at: ts(-6),
        updated_at: now,
      },
      {
        ...
        status: "watching",
        rating: 9,
        review: "Thorfinn's arc is incredible.",
        watched_date: null,
        source: "mal",
        external_id: "37521",
        ...
        synopsis: "Young Thorfinn joins Askeladd's crew to exact revenge, and is pulled into a brutal war that reshapes his idea of a true warrior.",
        site_url: "https://myanimelist.net/anime/37521",
        community_score: 8.7,
        airing_status: "Finished Airing",
        catalog: { duration: "24 min per ep", season: "Summer 2019", studios: ["Wit Studio"], source_material: "Manga" },
        created_at: ts(-3),
        updated_at: now,
      },
      {
        ...
        synopsis: "Self-proclaimed mad scientist Okabe Rintarou and his friends accidentally invent a microwave that can send messages to the past.",
        site_url: "https://myanimelist.net/anime/9253",
        community_score: 9.07,
        airing_status: "Finished Airing",
        catalog: { duration: "24 min per ep", season: "Spring 2011", studios: ["White Fox"], source_material: "Visual novel" },
        created_at: ts(-1),
        updated_at: now,
      },
    ],
